...
export default function Form() {
    ...
    useEffect(() => {
        ...
        const url = 'https://trains-backend-sufjqir6ra-uc.a.run.app/api/stations';
    ...
    function searchRoute() {
        ...
        axios.get('https://trains-backend-sufjqir6ra-uc.a.run.app/api/find_route', { params: { departure_date: date, start_station: start_station, end_station: end_station }})
            .then(response => {
