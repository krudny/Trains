...
export default function Reservation() {
    ...
    useEffect(() => {
        ...
        request("GET", 'https://trains-backend-sufjqir6ra-uc.a.run.app/api/getOccupiedSeats', {}, {
    ...
    useEffect(() => {
        ...
        request("GET", 'https://trains-backend-sufjqir6ra-uc.a.run.app/api/getAllSeats', {}, {})
            .then(response => {
                if (response.data) {
        ...
        request("GET", 'https://trains-backend-sufjqir6ra-uc.a.run.app/api/getAllDiscounts', {}, {})
            .then(response => {
                if (response.data) {
    ...
    function addReservation() {
        ...
        .then(response1=>{
            ...
            request("POST", 'https://trains-backend-sufjqir6ra-uc.a.run.app/api/reservations/add', {
